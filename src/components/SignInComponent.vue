            ...
            <div class="skiller_form_wrapper">
                ...
                <form action="" @submit.prevent="handleInput()" class="skiller_form">
                   ...
                   <label class="skiller_type_pass mb10">
                       ...
                       <input type="pass" placeholder="Password" v-model="password"  >
                  ...
                  <p id="forgot_pass" class="mb20"> <router-link to="/resetPass">Forgot Password?</router-link></p>
    ...
    methods:{
        handleInput(){
            ...
            // console.log('password', this.password);
               ...
               this.axios.post('http://192.168.0.132:8080/api/login/',{'email':this.email,'password':this.password})

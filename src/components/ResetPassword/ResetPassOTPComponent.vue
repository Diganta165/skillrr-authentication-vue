      ...
      <div class="skiller_sign_in_area d_flex align_center justify_center">
        <div class="skiller_sign_in_wrapper">
            ...
            <div class="skiller_form_wrapper">
                ...
                <div class="skiller_reset_info mb20">
                    <p class="mb10 txt_center">Enter the 4 digit code send to 
                        <a href="#" class="dblock">example@email.com</a>
                    </p>
                    <div class="resetOTP_box d_flex justify_between align_center mb6">
                        <div class="otp_box otp_box_one"></div>
                        <div class="otp_box otp_box_two"></div>
                        <div class="otp_box otp_box_three"></div>
                        <div class="otp_box otp_box_four"></div>
                    </div>
                    <div class="skiller_request_new_code txt_center">
                        <p><a href="#">Request new code</a></p>
                    </div>
                </div>
                <form action="" class="skiller_form">
                    <label class="skiller_type_pass mb20">
                ...
                <div class="skiller_sign_in_bottom pt20 txt_center" >
                    <p >Sign in instead? <a href="#"><router-link to='/signIn'>Sign In</router-link> </a> </p>

      ...
      <div class="skiller_sign_in_area d_flex align_center justify_center">
        <div class="skiller_sign_in_wrapper">
            ...
            <div class="skiller_form_wrapper">
                ...
                <div class="skiller_reset_info mb25">
                    <p class="mb10">Try with</p>
                    <div class="skiller_reset_try_tab">
                        <a href="#" class="mr15 skiller_reset_mail active" >Email</a>
                        <a href="#" class="skiller_reset_phone">Phone</a>
                    </div>
                </div>

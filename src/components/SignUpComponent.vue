<template>
  <div>
      <div class="skiller_sign_in_area skiller_sign_up_area d_flex align_center justify_center">
        <div class="skiller_sign_in_wrapper">
            ...
            <div class="skiller_form_wrapper">
                ...
                <form action="" class="skiller_form" @submit.prevent="handleRegester()">
                   ...
                   <label class="skiller_select_country mb20">
                       ...
                       <svg xmlns="http://www.w3.org/2000/svg" width="11.685" height="7" viewBox="0 0 11.685 7">
...
export default {
   ...
   methods:{
       handleRegester(){
           this.axios.post('http://192.168.0.132:8080/api/register/',{'firstName' : this.firstName, 'lastName': this.lastName, 'mobile': this.mobile, 'email': this.email})
